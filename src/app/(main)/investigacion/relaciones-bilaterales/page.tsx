...
import { MOCK_BILATERAL_HITOS } from '@/lib/data/mockData';

export default function RelacionesBilateralesPage() {
    ...
    <div className="pb-20 bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-40 px-10 bg-navy-900 border-b border-navy-900 w-full mb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-serif font-bold text-white mt-4 drop-shadow-2xl">Relaciones Bilaterales</h1>
      ...
      <div className="max-w-7xl mx-auto px-10">
        <div className="space-y-32">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="w-full lg:w-1/2 aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
              <img src="https://picsum.photos/seed/inf/800/600" alt="Inversion" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="w-full lg:w-1/2 space-y-6">
              <span className="text-accent font-bold text-xs uppercase tracking-[0.3em]">Inversión Extranjera</span>
              <h2 className="text-4xl font-serif font-bold text-primary leading-tight">Un ecosistema diseñado para el crecimiento</h2>
              <p className="text-gray-600 leading-relaxed text-lg">
                El Reino Unido se posiciona consistentemente como uno de los principales inversores extranjeros en el Perú, con especial énfasis en minería, agroindustria, infraestructura y finanzas sostenibles.
              </p>
              <button className="mt-4 bg-primary text-white px-8 py-4 rounded font-bold text-xs tracking-widest uppercase hover:bg-navy-800 transition-all shadow-md">
                Descargar Guía de Inversión
              </button>
            </div>
          </div>
        </div>
