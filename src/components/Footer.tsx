...
const Footer: React.FC = () => {
  return (
    <footer 
      className="text-white pt-20 pb-12 font-sans overflow-hidden"
      style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-6 pt-4">
              <Link href="https://www.facebook.com/CamaraPeruanoBritanica" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <Link href="https://www.instagram.com/britcham.pe/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <Link href="https://www.linkedin.com/company/camaraperuanobritanica/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
